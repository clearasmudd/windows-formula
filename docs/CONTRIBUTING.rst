...
.. |docs| image:: https://readthedocs.org/projects/docs/badge/?version=latest
   ...
   :scale: 100%
   :target: https://windows-formula.readthedocs.io/en/latest/?badge=latest
...
#. Use the
   :ref:`provided page windows <saltstack_formulas_rst_page_windows>`
...
SaltStack-Formulas' RST page windows
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. _saltstack_formulas_rst_page_windows

Use the following windows when creating a new page.
