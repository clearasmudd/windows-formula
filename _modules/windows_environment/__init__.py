# pylint: disable=locally-disabled, multiple-statements, too-many-locals, invalid-name, C0103, R1718
# -*- coding: utf-8 -*-
# vim: ft=py
# Author: https://github.com/xxsim3lu
# Source: https://github.com/saltstack/salt/issues/9876#issuecomment-488656118
# Issues: https://github.com/saltstack/salt/issues/47988,
# https://github.com/saltstack/salt/issues/55013,https://github.com/saltstack/salt/issues/9876
"""Refreshes the running minion environment."""
