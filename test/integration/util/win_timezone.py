# pylint: disable=locally-disabled, invalid-name, redefined-builtin, useless-object-inheritance, no-else-return, old-style-class; undefined-variable, D203
# -*- coding: utf-8 -*-
'''
...
class TzMapper(object):
    """TzMapper class: this doc string is driving me totally bonkers."""
...
def set_hwclock(clock):
    ...
    if clock:
        log.debug(
            "clock was passed but is unused as it is always localtime on Windows")
